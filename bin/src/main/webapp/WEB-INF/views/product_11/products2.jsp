...
<body>
	...
	<div class="container">
		...
		<nav class="main-nav">
			...
			<ul class="right-menu">
				<li><form:form method='POST' action="./queryproduct"
						class='form-horizontal'>
						<fieldset>
							<input name="productName" id="productName" type='text'
								class='form:input-large' /> <input id="btnAdd" type='submit'
		...
		<section class="home-cards">
			<c:forEach var='category' items='${categoryList}'>
				<div>
					...
					<h3>${category}</h3>
					<a href="<c:url value='/products/${category}' />">${category} <i
		...
		<section class="home-cards">
			...
			<div>
				...
				<p>Get students future-ready with Windows 10 devices. Starting
					at $219.</p>
				<a href="#">Shop Now <i class="fas fa-chevron-right"></i></a>
			</div>
			<div>
			...
			<div>
				...
				<p>Learn how Kubernetes works and get started with cloud native
					app development today.</p>
							...
							<div class="thumbnail">
								...
								<div class="caption">
									<h5 class="group inner list-group-item-heading"
										style="word-break: break-all;">${product.productName}</h5>
									<div class="row">
										...
										<div class="btn-group">
											<a class="btn btn-details"
												href="<spring:url value='/product?id=${product.productId}' />">Details</a>
											<a class="btn btn-success"
												href="<c:url value='/additem' />?id=${product.productId}">Add
												to cart</a>
										</div>
									</div>
								</div>
