...
<body>
			...
			<form method='POST' action="/try/tryIndex"  class='form-horizontal' >
		
                         <br><br><label for="">登入</label>
                   
			
					 <br><br>帳號&nbsp; &nbsp;<input id="userEmail" path="userEmail" type='text' class='emailLogin' style="width: 250px; height: 30px;" />
					 <br><br>密碼&nbsp;&nbsp; <input id="userPwd" path="userPwd" type='text' class='pwdLogin' style="width: 250px; height: 30px;" />              
                    ...
                    <input type="button" id="btnAdd"  name="submit" value="確認送出button" class="reg">
					<hr>
