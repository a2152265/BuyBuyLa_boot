...
<%-- 							<a class="conTitle" href="<c:url value='/detailed' />?id=${content.id}"> --%>
                                      <a class="button button-blog" href="<c:url value='/detailed' />?id=${content.id}">View More</a>
                                  </div>
                              </div>
                          </div>
                      </article>
					...
					<div class="modal-body insContentBody">
						...
						<div class="mb-3">
							...
							<form:textarea path="content" class="form-control content display-none"
								placeholder="請輸入內文" rows="4" col="1" id="recipient-name" />
