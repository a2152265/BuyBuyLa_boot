				...
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							<h4>已經有帳號了?</h4>
							<p></p>
							<a class="button button-account" href="<c:url value='/try/login' />">去登入</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner register_form_inner">
						...
						<!-- 創立帳號 -->
		<form:form method='POST' modelAttribute="loginBeanDefault"  class="row login_form" id="register_form">
						
							<div class="col-md-12 form-group">
								<form:input cssclass="form-control" style="width: 350px;"  path="userPhone" id="userPhone" name="name" placeholder="請輸入手機號碼" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" />
              ...
              <div class="col-md-12 form-group">
								<form:password  cssclass="form-control" style="width: 350px;" path="userPwd"  id="pwd" name="password" placeholder="請輸入密碼" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'" />
								<form:errors path="userPwd" cssClass="error"  style="color: red;" />
							</div>
              <div class="col-md-12 form-group">
								<form:password cssclass="form-control" style="width: 350px;"  path="userPwd1"  id="pwd1" name="confirmPassword" placeholder="確認密碼" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Confirm Password'" />
									<form:errors path="userPwd1" cssClass="error"  style="color: red;" />
							</div>
							<div class="col-md-12 form-group">
								<div class="creat_account">
									<input type="checkbox" id="f-option2" name="selector">
									<label for="f-option2">保持登入</label>
								</div>
							</div>
							<div class="col-md-12 form-group">
								<input id="onejan" type="button" value="一键输入註冊資料" class="reg" > 
								<button type="submit" value="submit" class="button button-register w-100">註冊</button>
							</div>
		</form:form>
					</div>
				</div>
