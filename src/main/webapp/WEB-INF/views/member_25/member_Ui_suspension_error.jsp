...
<%@ include file="../Home/member/member_25/sidebar.jspf"%>
                          ...
                          <div class="d-flex flex-row align-items-center mb-4">                  
                            <div class="form-outline flex-fill mb-0" style="text-align:center;">
          					...
          					<!-- 停權區 -->
                          <form:form method='POST' modelAttribute="suspension"
                          class="mx-1 mx-md-4" enctype="multipart/form-data">
                          
                            <div class="d-flex flex-row align-items-center mb-4">
                              <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                              <div class="form-outline flex-fill mb-0">
                             <form:password id="userPwd" path="userPwd" class="form-control" placeholder="請輸入密碼" />
                                 </div>
                            </div>                     
                            ...
                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                              <input type="submit"  onclick="return(confirm('確認停用帳號？'))"   id="submitRewrite" name="submitRewrite" class="btn btn-primary btn-lg" value="停用帳號">
                            </div>
