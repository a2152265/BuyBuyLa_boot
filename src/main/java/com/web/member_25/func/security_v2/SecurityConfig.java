	...
	protected void configure(HttpSecurity http)  throws Exception{
		...
		http.formLogin()     //自訂login
			...
			.and().authorizeRequests() //定義那些需要保護那些不需要
				  ...
				  //product_11
				  .antMatchers("/products/**","/product_11/**","/manage/**","/error/**","/manage/products/**","/product/**",
						  		"/categoryList/**","/getPicture/**","/comment/**","/products/**").permitAll()
				  //member_25
				  .antMatchers("/try/login/**","/try/add/**","/member/evolution/**","/member/suspension/**","/member/evolution/**","/member/**","/resetpp/**","/try/**","/try/member_Ui/**").permitAll()
				  //forum_32
